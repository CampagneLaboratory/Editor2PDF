...
public class EditorAnnotation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_rijbc_h0(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.BRACKETS_COLOR, 0, StyleRegistry.getInstance().getSimpleColor(MPSColors.blue));
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createCollection_rijbc_a_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createRefCell_rijbc_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_rijbc_b0(editorContext, node));
  ...
  private EditorCell createRefCell_rijbc_a0(EditorContext editorContext, SNode node) {
    ...
    provider.setNoTargetText("<no outputTo>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new EditorAnnotation_Editor._Inline_rijbc_a0a());
    editorCell = provider.createEditorCell(editorContext);
    if (editorCell.getRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setRole("outputTo");
