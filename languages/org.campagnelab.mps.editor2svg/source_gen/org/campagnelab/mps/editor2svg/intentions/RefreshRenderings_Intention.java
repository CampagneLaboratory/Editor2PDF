...
public class RefreshRenderings_Intention implements IntentionFactory {
  ...
  public String getConcept() {
    return "org.campagnelab.mps.editor2svg.structure.SvgCollection";
  }
  ...
  public String getPersistentStateKey() {
    return "org.campagnelab.mps.editor2svg.intentions.RefreshRenderings_Intention";
  }
  ...
  public SNodeReference getIntentionNodeReference() {
    return new SNodePointer("r:6bb9f222-b46c-45b3-85b5-99e8faaeadce(org.campagnelab.mps.editor2svg.intentions)", "893392931327280422");
  }
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      ListSequence.fromList(SModelOperations.getNodesIncludingImported(SNodeOperations.getModel(node), "jetbrains.mps.lang.core.structure.BaseConcept")).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return (AttributeOperations.getAttribute(it, new IAttributeDescriptor.NodeAttribute("org.campagnelab.mps.editor2svg.structure.EditorAnnotation")) != null) && SetSequence.fromSet(names).contains(SPropertyOperations.getString(AttributeOperations.getAttribute(it, new IAttributeDescriptor.NodeAttribute("org.campagnelab.mps.editor2svg.structure.EditorAnnotation")), "name"));
        }
      }).visitAll(new IVisitor<SNode>() {
        public void visit(SNode concept) {
          editorContext.select(concept);
          final SNode annotation = AttributeOperations.getAttribute(concept, new IAttributeDescriptor.NodeAttribute("org.campagnelab.mps.editor2svg.structure.EditorAnnotation"));
