...
public class EditorAnnotation_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_rijbc_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_rijbc_b0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_rijbc_c0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_rijbc_d0(editorContext, node));
    editorCell.addEditorCell(this.createCollection_rijbc_e0(editorContext, node));
    return editorCell;
  }

  private EditorCell createConstant_rijbc_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ">Write component to ");
  ...
  private EditorCell createProperty_rijbc_b0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_rijbc_d0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
    editorCell.setCellId("Constant_rijbc_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createCollection_rijbc_e0(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createVertical(editorContext, node);
    editorCell.setCellId("Collection_rijbc_e0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    style.set(StyleAttributes.BRACKETS_COLOR, StyleRegistry.getInstance().getSimpleColor(MPSColors.blue));
    editorCell.getStyle().putAll(style);
    editorCell.setUsesBraces(true);
    editorCell.addEditorCell(this.createAttributedNodeCell_rijbc_a4a(editorContext, node));
    return editorCell;
  }

  private EditorCell createAttributedNodeCell_rijbc_a4a(EditorContext editorContext, SNode node) {
    IOperationContext opContext = editorContext.getOperationContext();
    EditorManager manager = EditorManager.getInstanceFromContext(opContext);
